import { pgTable, pgSchema, index, foreignKey, uuid, text, date, pgEnum, numeric, varchar, timestamp, unique, boolean, uniqueIndex, jsonb } from "drizzle-orm/pg-core"
...
export const item = pgTable('item', {
  ...
  room_location: uuid('room_location_id').references(() => room_location.id, { onDelete: 'cascade' }),
